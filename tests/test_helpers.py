...
from kitchen.models import Recipe, Ingredient, RecipeIngredient, ShoppingListItem
...
class IngredientTest(KitchenTestCase):
    ...
    def test_generate_pdf(self):
        ShoppingListItem.objects.create(shopping_list=self.shopping_list, ingredient=self.tomato, quantity=2, unit='pcs')
