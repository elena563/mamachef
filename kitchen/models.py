...
class RecipeIngredient(models.Model):
    ...
    quantity = models.CharField(max_length=100, null=True, blank=True, verbose_name='Quantity', help_text='The quantity of the ingredient needed for the recipe (e.g., 2 cups, 1 tablespoon)')
...
class ShoppingListItem(models.Model):
    ...
    quantity = models.CharField(max_length=100, null=True, blank=True, verbose_name='Quantity', help_text='The quantity of the ingredient needed for the shopping list (e.g., 2 cups, 1 tablespoon)')

    def __str__(self):
        return f"{self.quantity} of {self.ingredient.name} for {self.shopping_list.name}"
